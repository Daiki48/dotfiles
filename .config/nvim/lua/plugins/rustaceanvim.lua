...
return {
  ...
  keys = {
    ...
    { "<leader>rd", function() vim.cmd.RustLsp("renderDiagnostic") end, desc = "Render Diagnostic", ft = "rust" },
    { "<leader>rr", function() vim.cmd.RustLsp("runnables") end, desc = "Runnables", ft = "rust" },
    { "<leader>rt", function() vim.cmd.RustLsp("testables") end, desc = "Testables", ft = "rust" },
